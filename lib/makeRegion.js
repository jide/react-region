...
exports['default'] = function () {
  ...
  var RegionComponent = arguments.length <= 1 || arguments[1] === undefined ? _Region2['default'] : arguments[1];
  console.log('ttttt');
  return (function (_Component) {
    ...
    _createClass(RegionContainer, [{
      ...
      value: function render() {
        return _react2['default'].createElement(RegionComponent, _extends({ types: types }, this.props));
      }
    }]);
